<%-- 
    Document   : Patient_Change_Doctor_Page
    Created on : 31 Mar, 2020, 10:59:57 AM
...
<body>
    ...
    <%
            ...
            String specalization=(String)session.getAttribute("disease");
            try {
                PreparedStatement ps1=connection.prepareStatement("SELECT * FROM doctor WHERE location=? and specalization=?");
                ps1.setString(1,location);
                ps1.setString(2,specalization);
                String a=null;
    %>
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Choose Doctor</h2>
                    <form method="POST" action="Patient_Change_Doctor.jsp">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                ...
                                <select name="doctor">
                                    ...
                                    <%
                                        ...
                                        while(rs.next()) {
                                            a=rs.getString("doctorname");
                                    %>
                                    <option name="doctor" value="<%=a%>"><%=a%></option> 
                                <%
