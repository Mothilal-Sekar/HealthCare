<%-- 
    Document   : Admin_Doctor_Page
    Created on : 31 Mar, 2020, 2:40:49 PM
...
@media screen and (max-width: 767px) {
    ...
    <body>
        ...
        <div class="Menu-Bar">
            <ul>
				...
				<li class="active"><a href="Admin_Doctor_Page.jsp"><i class="fa fa-user-md" aria-hidden="true"></i>Doctor</a></li>
                                <li><a href="Admin_Patient_Emergency_Page.jsp"><i class="fa fa-heartbeat" aria-hidden="true"></i>Emergency</a></li>
				<li><a href="index.html"><i class="fa fa-sign-out" aria-hidden="true"></i></i>Logout</a></li>
            </ul>
		</div>
    ...
    try
    {
     PreparedStatement ps1=connection.prepareStatement("select doctorname,email,age,gender,phonenumber,specalization,location from doctor ");
