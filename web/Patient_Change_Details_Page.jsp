<%-- 
    Document   : Patient_Edit_Page
    Created on : 28 Apr, 2020, 7:21:31 PM
    Author     : MLDon_PC
--%>
...
<head>
    ...
    <!-- Title Page-->
    <title>Patient Change Details</title>
...
<body>
    ...
    session.setAttribute("o_email",email);
    session.setAttribute("o_name",name);
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Change Your Details</h2>
                    <form method="POST" action="Patient_Change_Details.jsp">
