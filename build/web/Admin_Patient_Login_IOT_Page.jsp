<%-- 
    Document   : Admin_Patient_Login_IOT_Page
    Created on : 26 Apr, 2020, 2:37:41 PM
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="Admin_Patient_Login_IOT.jsp">
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">Start IOT Devices</button>
                        </div>
                    </form>
                </div>
            </div>
