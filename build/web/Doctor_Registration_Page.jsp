<%-- 
    Document   : Doctor_Registration_Page
    Created on : 27 Mar, 2020, 7:46:18 PM
...
<body>
    ...
    <div class="Menu-Bar">
			<ul>
				...
				<li class="active"><a href="#"><i class="fa fa-user-plus"></i>Doctor</a>
					<div class="Sub-Menu-1">
						<ul>
                    ...
                    <form method="POST" action="Doctor_Register.jsp">
                                ...
                                <div class="input-group" >
                                    ...
                                    <div class="p-t-10" >
                                        <label class="radio-container m-r-45">Male
                                            <input type="radio" name="doctor_gender" value="Male" required="" title="Choose Any GENDER">
                                        ...
                                        <label class="radio-container">Others
                                            <input type="radio" name="doctor_gender" value="Others">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="input-group">
                                ...
                                <div class="select-dropdown">
                                    <select name="doctor_location" required="">
                                    <option disabled="disabled" selected="selected" value="">Choose new location</option>
